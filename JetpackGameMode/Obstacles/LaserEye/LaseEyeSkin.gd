...
func _ready():
	warning_animator1 = get_node("Eye/Eye/ColorChange1/ColorChanger1")
	warning_animator2 = get_node("Eye/Eye/ColorChange2/ColorChanger2")
	warning_animator3 = get_node("Eye/Eye/ColorChange3/ColorChanger3")


func set_warning_color1(value):
	warning_color_1 = value
	set_warning_color(warning_animator1, value)


func set_warning_color2(value):
	warning_color_2 = value
	set_warning_color(warning_animator2, value)


func set_warning_color3(value):
	warning_color_3 = value
	set_warning_color(warning_animator3, value)


func set_warning_color(animator, value):
	if animator == null:
		return
